...
def display_operations():
    ...
    operations = [operation for operation in datas if 'date' in operation and 'from' in operation]
    ...
    for operation in sorted_operations[:5]:
        ...
        print(f"{date} {description} {masked_from_account} -> {masked_to_account} {amount} {currency}\n")
...
def mask_account_number(account_number):
    ...
    if account_number.startswith('Maestro'):
        ...
        masked_number = '*' * 5 + ' ' + account_number[-4:]
    else:
